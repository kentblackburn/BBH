...
/* Modification of extreme5c to place a loop around the J values.
*/
...
#define FIND_MIN     YES
#define STEST        0.75
#define TOL          1.0e-6 /* change 5 to 6 */
#define INTGRLEPS    1.0e-8 /* change to -8 */
#define PI           3.14159265358979323846
#define EPSILON      1.0e-10
#define FILENAME     "eqm.log"
#define FTABULAR     "equal_mass.data"
#define M1IRRBLE     1.00
#define M2IRRBLE     1.00
#define JMINDENS     1.00
#define JDENSITY    15.00
#define DJDEN        1.00
#define SCENTER0   442.00
#define DS           0.20
...
double Rmax   =  1000000.00,
       M1irr  =   M1IRRBLE,
       M2irr  =   M2IRRBLE,
       Sbegin =     SCENTER0 + 2.0 * DS,
       Send   =     SCENTER0 - 2.0 * DS,
       DeltaS =     -DS,
...

{
 ...
 while ( Jtotal >= JMINDENS*M1IRRBLE*M2IRRBLE)
      {
       fmin = M1irr + M2irr;
       fprintf(fP,"Jtotal = %g \n",Jtotal);
      ...
      /* For scanning - NOTE: Must scane hi to lo values of separation! */
      ...
      if (FIND_MIN == YES)
       ...
       Sbegin = xmin; Send = Sbegin - 3 * DS;
       Jtotal -= DJDEN * M1IRRBLE * M2IRRBLE;
      }
 fclose(fP);
}
